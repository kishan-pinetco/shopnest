                            ...
                            <div class="bg-white max-h-max rounded-md shadow-lg p-8">
                                ...
                                <div class="mt-12 grid grid-cols-1 gap-y-5 gap-x-3 md:grid-col-2">
                                    <div class="col-span-2">
                                        ...
                                        <input type="text" name="address" value="<?php echo isset($_COOKIE['user_id']) ? $row['Address'] : 'Sign In' ?>" class="border mt-1 rounded px-4 w-full bg-gray-50 focus:border-gray-500 focus:ring-2 focus:ring-gray-500">
                                    </div>
                                    <div class="col-span-2">
                                        <label for="state">State</label>
                                        <input type="text" name="state" id="" value="<?php echo isset($_COOKIE['user_id']) ? $row['state'] : 'Sign In' ?>" class="border mt-1 rounded px-4 w-full bg-gray-50 focus:border-gray-500 focus:ring-2 focus:ring-gray-500">
                                    </div>
                                    <div class="col-span-2 md:col-span-1">
                                        <label for="city">City</label>
                                        <input type="text" name="city" id="" value="<?php echo isset($_COOKIE['user_id']) ? $row['city'] : 'Sign In' ?>" class="border mt-1 rounded px-4 w-full bg-gray-50 focus:border-gray-500 focus:ring-2 focus:ring-gray-500">
                                    </div>
                                    <div class="col-span-2 md:col-span-1">
                                        <label for="Pincode">Pincode</label>
                                        <input type="number" name="Pincode" id="" value="<?php echo isset($_COOKIE['user_id']) ? $row['pin'] : '' ?>" class="border mt-1 rounded px-4 w-full bg-gray-50 focus:border-gray-500 focus:ring-2 focus:ring-gray-500">
                                    </div>
