            ...
            <div class="flex flex-col flex-1">
                ...
                <section class="relative pt-7">
                    <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                        ...
                        <div class="w-full px-3 overflow-auto min-[400px]:px-6 lg:h-[60vh] lg:overflow-scroll">
                            <div class="flex flex-col md:flex-row items-center py-6 border-b border-gray-200 gap-6 w-full">
                                <div class="img-box max-lg:w-full">
                                    <a href="">
                                        <img class="aspect-square w-full lg:max-w-[140px]" src="https://m.media-amazon.com/images/I/81Os1SDWpcL._SL1500_.jpg" alt="">
                                    </a>
                                </div>
                                <div class="flex flex-row items-center w-full ">
                                    <div class="grid grid-cols-1 lg:grid-cols-2 w-full">
                                        <div class="flex items-center">
                                            <div class="">
                                                <a href="">
                                                    <h2 class="font-semibold text-xl leading-8 text-black mb-3 line-clamp-2 w-[90%]">Apple iPhone 15 Pro Max (256 GB) - Black Titanium</h2>
                                                </a>
                                                <div class="flex items-center">
                                                    ...
                                                    <p class="font-medium text-base leading-7 text-black">Price: <span class="text-indigo-600">₹1,48,900</span></p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="grid grid-cols-5">
                                            ...
                                            <div class="col-span-5 lg:col-span-2 flex items-center max-lg:mt-3">
                                                <div class="flex flex-col items-center gap-2">
                                                    ...
                                                    <p class="font-medium text-base whitespace-nowrap leading-7 text-emerald-500">21-07-2024</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
