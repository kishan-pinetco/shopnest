                                                        ...
                                                        <div class="flex items-center">
                                                            <div class="">
                                                                ...
                                                                <div class="flex items-center">
                                                                    ...
                                                                    <p class="font-medium text-base leading-7 text-black">Price: <span class="text-gray-600">₹<?php echo isset($_COOKIE['user_id']) ? $res['total_price'] : 'product total_price' ?></span></p>
                                                                </div>
                                                            </div>
                                                        </div>
