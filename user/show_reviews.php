    ...
    <div>
        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div class="flex flex-col flex-1">
                ...
                <div class="px-6 py-8 mx-auto bg-gray-200 w-full">
                    <h3 class="text-3xl font-medium text-gray-700">Your Reviews</h3>
                    <div class="grid grid-cols-1 gap-6 w-full mt-6 md:grid-cols-2 xl:grid-cols-3">
                        <div class="bg-white shadow-lg h-max p-3 rounded-md">
                            <a href="">
                                <div class="flex flex-col gap-y-4 items-start justify-between md:flex-row">
                                    <div class="flex item-center justify-center gap-3">
                                        ...
                                        <div class="flex flex-col gap-0">
                                            <h2 class="font-medium text-base text-neutral-800">User Xyz</span></h2>
                                ...
                                <div class="mt-6">
                                    ...
                                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Numquam error ab sunt beatae illo consequatur doloribus amet possimus assumenda? Dignissimos.</p>
                                </div>
                            </a> 
                            <div class="flex item-center justify-between mt-4">
                                <a href="" class="text-green-600 underline underline-offset-4">Edit</a>
                                <a href="" class="text-red-600 underline underline-offset-4">Delete</a>
                            </div>
                        </div>
                    </div>    
                </div>
