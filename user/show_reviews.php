                                    ...
                                    ?>
                                        <div class="bg-white shadow-lg h-max rounded-tl-xl rounded-br-xl overflow-hidden">
                                            ...
                                            <div class="flex item-center justify-between mt-4 bg-gray-600 px-3 py-2">
                                                <a href="edit_review.php?product_id=<?php echo $rev['product_id']?>&review_id=<?php echo $rev['review_id']?>" class="text-green-600 bg-white border-2 border-gray-800 px-4 py-0.5 rounded-tl-lg rounded-br-lg">Edit</a>
                                                <a href="delete_review.php?product_id=<?php echo $rev['product_id']?>&review_id=<?php echo $rev['review_id']?>" class="text-red-600 bg-white border-2 border-gray-800 px-4 py-0.5 rounded-tl-lg rounded-br-lg">Delete</a>
                                            </div>
                                        </div>
                                    <?php
                                }
