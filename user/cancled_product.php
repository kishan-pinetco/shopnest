                                                    ...
                                                    <div class="grid grid-cols-1 lg:grid-cols-2 w-full">
                                                        <div class="flex items-center">
                                                            <div class="">
                                                                ...
                                                                <div class="flex items-center">
                                                                    <p class="font-medium text-base leading-7 text-black">Price: <span class="text-gray-600">₹<?php echo isset($_COOKIE['user_id']) ? $res['cancle_order_price'] : 'cancle_order_price' ?></span></p>
                                                                </div>
                                                            </div>
                                                        </div>
