        ...
        <form action="" method="post">
            ...
            <div>
                <div class="headline">
                    ...
                    <input class="w-full h-12 border-2 border-[#cccccc] rounded-md focus:border-black focus:ring-0 mt-2" type="text" value="" id="headline" name="headline" placeholder="What's most important to know?" required>
                </div>
                <hr class="my-6">
                <div class="review">
                    <p class="cursor-default font-semibold text-2xl">Add a written review</p>
                    <input class="w-full h-12 border-2 border-[#cccccc] rounded-md focus:border-black focus:ring-0 mt-2" type="text" value="" id="review" name="review" placeholder="What did you like or dislike? What did you use this product for?" required>
                </div>
                <hr class="my-6">
                <div class="public_Name">
                    ...
                    <div class="flex item-center justify-center m-auto gap-2">
                        ...
                        <input class="w-full h-12 border-2 border-[#cccccc] rounded-md focus:border-black focus:ring-0 mt-2" type="text" id="public_Name" name="public_Name" value="" required>
                    </div>
                </div>
