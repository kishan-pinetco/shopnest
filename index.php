        ...
        <div id="default-carousel" class="relative w-full" data-carousel="slide">
            ...
            <div class="relative h-56 overflow-hidden rounded-lg md:h-[25rem]">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img class="h-56 sm:h-[25rem] w-full" src="https://www.theroyalshopbarbados.com/wp-content/uploads/2021/09/Tissot-Banner.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Image 1">
                    <a class="absolute bottom-5 left-5 sm:bottom-14 sm:left-14 bg-indigo-500 text-white sm:w-32 text-center py-1.5 sm:py-2 px-2 rounded-md text-xs sm:text-lg" href="">Buy Now</a>
                </div>
                <!-- Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img class="h-56 sm:h-[25rem] w-full" src="https://www.lg.com/levant_en/images/plp-b2c/tv-uhd-hero-banner-desktop.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Image 2">
                    <a class="absolute bottom-5 left-5 sm:bottom-14 sm:left-14 bg-indigo-500 text-white sm:w-32 text-center py-1.5 sm:py-2 px-2 rounded-md text-xs sm:text-lg" href="">Buy Now</a>
                </div>
                <!-- Item 3 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img class="h-56 sm:h-[25rem] w-full" src="https://dlcdnwebimgs.asus.com/gain/3EF9B6B3-0408-42CE-9AA2-50B46B5B35C9/fwebp" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Image 3">
                    <a class="absolute bottom-5 left-5 sm:bottom-14 sm:left-14 bg-indigo-500 text-white sm:w-32 text-center py-1.5 sm:py-2 px-2 rounded-md text-xs sm:text-lg" href="">Buy Now</a>
                </div>
            </div>
            <!-- Slider indicators -->
            ...
            <button type="button" class="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-prev>
                <span class="inline-flex items-center justify-center w-5 h-5 sm:w-10 sm:h-10 rounded-full bg-white hover:ring-2 hover:ring-indigo-500">
                    <svg class="w-2 h-2 sm:w-4 sm:h-4 text-black rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
