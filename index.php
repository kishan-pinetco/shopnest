...
<body>
    ...
    <div class="p-2 flex flex-col items-center max-w-screen-lg m-auto outfit">
        ...
        <div class="max-w-screen-lg m-auto px-5 relative pt-4 pb-8">
            <!-- Swiper -->
            <div class="swiper mySwiper relative w-full h-full rounded-lg">
                ...
                <div class="">
                    <div class="prev-button w-8 h-8 z-50 absolute top-[50%] text-center flex items-center justify-center left-3">
                        <svg class="bg-white rounded-full w-8 h-8" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                            <g>
                    ...
                    <div class="next-button w-8 h-8 z-50 absolute top-[50%] text-center flex items-center justify-center right-3">
                        <svg class="bg-white rounded-full w-8 h-8" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512" x="0" y="0" viewBox="0 0 128 128" style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
                            <g>
        ...
        <div class="p-3 mt-5 border rounded-lg transition transform hover:shadow-lg hover:shadow-black w-56">
            <div>
