        ...
        <div class="md:flex justify-between gap-10 px-8 py-4 space-y-5 sm:space-y-0">
            <div>
                <a class="flex" href="../index.php">
                    <!-- icon logo div -->
                    <div>
                            <svg class="w-8 sm:w-10  mb-2" id="svg" version="1.1" viewBox="0 0 235 245" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <!-- text logo -->
                    <div>
                            <svg class="w-20 sm:w-32 mt-1" viewBox="0 0 350 112.41287475877095" class="looka-1j8o68f">
