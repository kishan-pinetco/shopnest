...
<head>
    ...
    <title><?php echo isset($Brand) ? $Brand : 'Product brandName' ?></title>
...
<body class="outfit">
    ...
    <div class="px-3 sm:px-16 outfit mt-5" id="main-content">
        <div class="flex justify-between items-center border-b-2 border-gray-300 pb-3">
            <div>
                <h1 class="text-lg sm:text-3xl text-gray-800"><?php echo $Brand; ?></h1>
            </div>
        ...
        <div class="flex jutify-center">
            <div class="mt-7 w-64 hidden lg:block">
                <form method="post">
                    ...
                    <div class="border-b-2 border-gray-300 pb-4 mt-3">
                        ...
                        <div class="mt-3 text-gray-600">
                            <ul class="space-y-2 text-gray-700">
                                <?php
                                $select_color = "SELECT * FROM items WHERE company_name = '$Brand'";
                    ...
                    <div class="border-b-2 border-gray-300 pb-4 mt-3">
                        ...
                        <div class="mt-2 text-gray-700">
                            <ul class="space-y-2">
                                <?php
                                $select_size = "SELECT size FROM items WHERE company_name = '$Brand'";
                ...
                $Brand = $_GET['brandName'];
                if ($filter_query) {
                    $products = "SELECT * FROM items WHERE company_name = '$Brand' AND $filter_query";
                } elseif ($selected === 'Newest') {
                    $products = "SELECT * FROM items WHERE company_name = '$Brand'";
                } elseif ($selected === 'All') {
                    $products = "SELECT * FROM items WHERE company_name = '$Brand'";
                } elseif ($selected === 'Low to High') {
                    $products = "SELECT * FROM items WHERE company_name = '$Brand' ORDER BY CAST(REPLACE($sort_column, ',', '') AS UNSIGNED) $sort_order";
                } elseif ($selected === 'High to Low') {
                    $products = "SELECT * FROM items WHERE company_name = '$Brand' ORDER BY CAST(REPLACE($sort_column, ',', '') AS UNSIGNED) DESC";
