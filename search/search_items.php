                    ...
                    <div class="border-b-2 border-gray-300 pb-4">
                        ...
                        <div class="mt-3 text-gray-600">
                            <ul class="space-y-2 text-sm text-gray-800">
                                ...
                                <li class="flex items-center gap-2"><input type="checkbox" class="rounded h-[15px] w-[15px] text-gray-700 focus:ring-gray-700" value="over_100k" name="price[]" id="under_100k"><label class="text-sm" for="under_100k">Over ₹1,00,000</label></li>
                            </ul>
                        </div>
                    </div>
