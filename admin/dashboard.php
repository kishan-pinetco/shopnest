                ...
                <main id="main" class="px-4 md:px-12 py-12 overflow-y-scroll overflow-hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
                        <div class="flex items-center gap-4 bg-white shadow-xl rounded-md px-4 py-3">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-indigo-950"><?php echo isset($_COOKIE['adminEmail']) ? $Cview : '0'?></h3>
                        ...
                        <div class="flex items-center gap-4 bg-white shadow-xl rounded-md px-4 py-3">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-indigo-950"><?php echo isset($_COOKIE['adminEmail']) ? '₹' . number_format($totalEarnings) : '0'?></h3>
                        ...
                        <div class="flex items-center gap-4 bg-white shadow-xl rounded-md px-4 py-3">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-indigo-950"><?php echo isset($_COOKIE['adminEmail']) ? $products : '0'?></h3>
                        ...
                        <div class="flex items-center gap-4 bg-white shadow-xl rounded-md px-4 py-3">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-indigo-950"><?php echo isset($_COOKIE['adminEmail']) ? $user : '0'?></h3>
                        ...
                        <div class="flex items-center gap-4 bg-white shadow-xl rounded-md px-4 py-3">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-indigo-950"><?php echo isset($_COOKIE['adminEmail']) ? $vendor : '0'?></h3>
