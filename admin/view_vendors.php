                                    ...
                                    <div class="w-full h-auto m-auto bg-white rounded-tl-3xl rounded-br-3xl shadow-lg text-center overflow-hidden">
                                        ...
                                        <div class=" text-center">
                                            ...
                                            <div class="flex justify-between items-center divide-x-2 border-t-2">
                                                <a href="tel:<?php echo isset($_COOKIE['adminEmail']) ? $row['phone'] : 'phone' ?>" class="flex justify-center items-center space-x-1 w-full py-2 text-green-600">
                                                ...
                                                <button class="flex justify-center items-center space-x-1 w-full py-2 text-red-600">
