        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                ...
                <main class="verflow-x-hidden overflow-y-auto bg-gray-200">
                    <div class="grid md:grid-cols-3 gap-6 mx-4 md:mx-12 my-12">
                        <div class="bg-white shadow-lg">
                            <div class="relative">
                                <div class="h-40">
                                    <img class="h-full w-full" src="https://demo.tailadmin.com/src/images/cover/cover-01.png" alt="">
                                </div>
                                <div class="absolute top-0 left-0 p-2 flex flex-col gap-1 text-gray-300 bg-black/30 w-full h-full">
                                    <h2>Abhijeet Dabhi</h2>
                                    <span>7894561231</span>
                                    <span>abhijeet@gmail.com</span>
                                </div>
                            </div>
                            <div class="bg-white/20 filter backdrop-blur-xl w-24 h-24 rounded-full p-2 m-auto -translate-y-16">
                                <img src="https://demo.tailadmin.com/src/images/user/user-06.png" alt="">
                            </div>
                            <div class="-mt-12 text-center pb-4">
                                <h2 class="text-lg font-medium text-indigo-950">About</h2>
                                <span class="text-sm font-normal text-gray-800 mt-4 m-auto">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatibus fugit quam odit nostrum modi perspiciatis ut! Porro odio aspernatur excepturi.</span>
                            </div>
                        </div>
                        ...
                        <div class="bg-white shadow-lg">
                            <div class="relative">
                                <div class="h-40">
                                    <img class="h-full" src="https://demo.tailadmin.com/src/images/cover/cover-01.png" alt="">
                                </div>
                                <div class="absolute top-0 left-0 p-2 flex flex-col gap-1 text-gray-300 bg-black/30 w-full h-full">
                                    <h2>Abhijeet Dabhi</h2>
                                    <span>7894561231</span>
