        ...
        <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
            ...
            <div class="flex flex-col flex-1 overflow-hidden">
                ...
                <main class="verflow-x-hidden overflow-y-auto bg-gray-200">
                    <!-- <div class="grid grid-cols-1 min-[604px]:grid-cols-2 min-[1256px]:grid-cols-3 grid-cols-4 gap-6 mx-4 md:mx-12 my-12"> -->
                                   ...
                                   ?>
                                        <div class="w-full h-auto m-auto bg-white rounded-3xl shadow-lg pb-6 text-center">
                                            ...
                                            <div class="px-6 text-center mt-2">
                                                ...
                                                <a href="mailto:<?php echo isset($_COOKIE['adminEmail']) ? $row['email'] : 'email' ?>" class="text-sm text-indigo-500"><?php echo isset($_COOKIE['adminEmail']) ? $row['email'] : 'email' ?></a>
                                                <a href="tel:<?php echo isset($_COOKIE['adminEmail']) ? $row['phone'] : 'phone' ?>" class="mt-4 px-4 py-2 flex items-center justify-center max-w-max m-auto gap-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">
