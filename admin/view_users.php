                            ...
                            <?php
                                ...
                                if($retrieve_query){
                                    while($res = mysqli_fetch_assoc($retrieve_query)){
                                        ?>
                                            <div class="bg-white rounded-3xl shadow-lg p-6 text-center grid place-items-center">
                                                ...
                                                <h2 class="mt-4 text-xl font-semibold"><?php echo isset($_COOKIE['adminEmail']) ? $res['first_name'] . $res['last_name'] : '' ?></h2>
                                                ...
                                                <a href="tel:<?php echo isset($_COOKIE['adminEmail']) ? $res['phone'] : '' ?>" class="mt-4 px-4 py-2 flex items-center gap-2 bg-gray-600 text-white rounded-tl-xl rounded-br-xl hover:bg-gray-700 transition">
