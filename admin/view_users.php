                                    ...
                                    while($res = mysqli_fetch_assoc($retrieve_query)){
                                        ?>
                                            <div class="bg-white rounded-3xl shadow-lg p-6 text-center grid place-items-center">
                                                ...
                                                <a href="mailto:<?php echo isset($_COOKIE['adminEmail']) ? $res['email'] : '' ?>" class="text-sm text-indigo-500"><?php echo isset($_COOKIE['adminEmail']) ? $res['email'] : '' ?></a>
                                                <a href="tel:<?php echo isset($_COOKIE['adminEmail']) ? $res['phone'] : '' ?>" class="mt-4 px-4 py-2 flex items-center gap-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition">
