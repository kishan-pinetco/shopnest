                ...
                <main id="main" class="px-4 md:px-12 py-12 overflow-y-scroll overflow-hidden">
                    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                        <div class="flex items-center gap-4 bg-white shadow-xl rounded-md px-4 py-3">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-indigo-500"><?php echo '₹' . number_format($totalSale); ?></h3>
                        ...
                        <div class="flex items-center gap-4 bg-white shadow-xl rounded-md px-4 py-3">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-green-600"><?php echo '₹' . number_format($totalEarnings); ?></h3>
                        ...
                        <div class="flex items-center gap-4 bg-white shadow-xl rounded-md px-4 py-3">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-indigo-950"><?php echo $products; ?></h3>
                        ...
                        <div class="flex items-center gap-4 bg-white shadow-xl rounded-md px-4 py-3">
                            ...
                            <div>
                                <h3 class="text-2xl font-bold text-indigo-950"><?php echo $order;?></h3>
