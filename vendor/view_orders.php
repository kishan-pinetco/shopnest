                ...
                <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                            ...
                            <?php
                                if (isset($_COOKIE['vendor_id'])) {
                                    ...
                                    if(mysqli_num_rows($get_orders_query) > 0){
                                        ?>
                                        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg" id="place"></div>
                                        ...
                                        ?>
                                            <h1 class="text-xl text-center">No Record Found</h1>
                                        <?php
                                    }
                                }
                            ?>  
                    ...
                    <section class="container mx-auto p-6">
                        ...
                        if (isset($_COOKIE['vendor_id'])) {
                            ...
                            $get_cancel_orders_query = mysqli_query($con, $get_orders);

                            if(mysqli_num_rows($get_cancel_orders_query) > 0){
                                ?>
                                    <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
                                        <div class="w-full overflow-x-auto scrollBar h-max text-center">
                                            <table class="w-full">
                                                ...
                                                <?php
                                                while ($co = mysqli_fetch_assoc($get_cancel_orders_query)) {
                                                    ?>
                                                    <tbody class="bg-white border">
                                                        <tr class="text-gray-700">
                    ...
                    <section class="container mx-auto p-6">
                        ...
                        <?php
                            if (isset($_COOKIE['vendor_id'])) {
                                ...
                                $get_return_order = mysqli_query($con, $get_orders);

                                if(mysqli_num_rows($get_return_order) > 0){
                                    ?>
                                        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
                                            <div class="w-full overflow-x-auto scrollBar h-max text-center">
                                                <table class="w-full">
                                                    ...
                                                    <?php
                                                        while ($ro = mysqli_fetch_assoc($get_return_order)) {
                                                    ?>
                                                            <tbody class="bg-white border">
                                                                <tr class="text-gray-700">
