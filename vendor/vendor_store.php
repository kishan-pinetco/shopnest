                        ...
                        while($res = mysqli_fetch_assoc($vendorProduct_query)){
                            ...
                            <div class="w-full flex-shrink-0 p-4">
                                <div class="p-3 border rounded-lg transition transform hover:shadow-lg bg-white">
                                    <div>
                                        <img src="<?php echo isset($vendor_id) ? '../src/product_image/product_profile/' . $res['image_1'] : 'Product Image' ?>" alt="" class="w-full h-60 object-cover object-top rounded" loading="eager" sizes>
                                    </div>
                                    <div class="mt-2">
                                        <div class="space-y-1">
                                            <a href="../product/product_detail.php?product_id=<?php echo $res['product_id']; ?>" class="text-base font-medium line-clamp-2"><?php echo isset($vendor_id) ? $res['title'] : 'Product Title' ?></a>
                                            <p class="space-x-2">
                                                <del class="text-gray-400">₹<?php echo isset($vendor_id) ? $res['MRP'] : 'Product MRP' ?></del>
                                                <span class="text-indigo-500">₹<?php echo isset($vendor_id) ? $res['Your_Price'] : 'Product Price' ?></span>
                                            </p>
                                        </div>
