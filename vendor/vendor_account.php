                                                ...
                                                <div class="col-span-4 flex flex-col items-center relative mt-3">
                                                    <div class="w-full p-5">
                                                        <div class="w-full relative">
                                                            ...
                                                            <label for="Coverimage" class="absolute top-0 right-0 mt-1 mr-1 md:mb-4 md:mr-4 text-white bg-gray-600 flex items-center gap-1 max-w-max px-3 py-1 rounded-tl-lg rounded-br-lg cursor-pointer hover:bg-gray-700 transition duration-300">
