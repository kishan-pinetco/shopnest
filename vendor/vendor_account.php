                                            ...
                                            <div class="grid gap-4 gap-y-4 items-center text-sm grid-cols-1 md:grid-cols-4">
                                                <div class="col-span-4 flex flex-col items-center relative mt-3">
                                                    <div class="w-full p-5">
                                                        <div class="w-full relative">
                                                            ...
                                                            <label for="Coverimage" class="absolute top-0 right-0 mt-2 mr-1 md:mb-4 md:mr-2 text-white bg-gray-600 flex items-center gap-1 max-w-max px-3 py-1 rounded-tl-lg rounded-br-lg cursor-pointer hover:bg-gray-700 transition duration-300">
                                                ...
                                                <div class="col-span-4 text-right mt-7">
                                                    <div class="inline-flex items-end">
                                                        <input type="submit" value="Update" name="updateBtn" class="bg-gray-600 hover:bg-gray-700 text-white font-semibold py-2 px-4 rounded-tl-lg rounded-br-lg cursor-pointer">
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
