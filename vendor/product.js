...
document.getElementById('add-input').addEventListener('click', function() {
    ...
    // Create a new container for the color input and its remove button
    ...
    // Append the input and remove button to the color item container
    colorItem.appendChild(newInput);
    colorItem.appendChild(removeButton);

    // Append the color item container to the main container
