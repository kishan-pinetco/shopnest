...
<body class="h-[100vh] flex flex-col justify-center items-center outfit">
    ...
    <div class="w-80 md:w-96 border-2 border-gray-300 space-y-3 rounded-xl bg-white overflow-hidden" id="forgotPass-container">
        ...
        <form action="" method="post" id="form2" class="flex flex-col items-center pb-5">
            ...
            <div class="space-x-5 mt-5 flex items-center justify-between">
                <button id="back1" onclick="window.location.href='forgotPass_email_vendor.php'" type="button" class="bg-black px-2 w-28 md:w-32 text-white tracking-wide h-10 rounded-tl-xl rounded-br-xl flex items-center justify-center gap-1">
