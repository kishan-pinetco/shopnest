...
<body class="h-[100vh] flex flex-col justify-center items-center outfit">
    ...
    <div class="w-96 border-2 border-gray-300 space-y-3 rounded-xl bg-white overflow-hidden" id="forgotPass-container">
        ...
        <form action="" id="form2" class="flex flex-col items-center pb-5">
            <div class="flex flex-col space-y-3">
                ...
                <small class="w-full text-red-500 text-sm mt-0.5 -translate-y-2">Error!</small>
            </div>
            ...
            <a href="login.html" class="mt-5 flex justify-center items-center">
