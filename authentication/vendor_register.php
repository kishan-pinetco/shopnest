        ...
        <form action="">
            <div class="border-2 rounded-md">
                ...
                <div class="w-full flex flex-col items-center relative mt-3">
                    <img id="previewImage" alt="" src="https://w7.pngwing.com/pngs/178/595/png-transparent-user-profile-computer-icons-login-user-avatars-thumbnail.png" class="w-20 h-20 rounded-full border object-cover object-center border-black">
