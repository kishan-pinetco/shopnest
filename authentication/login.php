...
<body class="flex justify-center items-center h-[100vh] p-2">
    <div class="w-96">
        ...
        <div class="p-2 flex items-center justify-center">
            <img class="w-24 h-24 translate-y-1 translate-x-1" src="../src/logo/logo3.svg" alt="">
            <div>
            ...
            <form action="">
                <div class="space-y-4 mt-4">
                    ...
                    <div class="flex flex-col gap-1 relative" x-data="{ showPassword: false }">
                        ...
                        <span class="absolute top-[2.70rem] right-2.5 cursor-pointer" x-on:click="showPassword = !showPassword"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);">
